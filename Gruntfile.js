module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        file_append: {
            default_options: {
                files: [{
                    append: "\n\rmodule.exports = Utils;",
                    prepend: "",
                    input: resourcesPath + '/js/scratch_57.js',
                    output: resourcesPath + '/js/scratch_57_export.js'
                }]
            }
        }
    ...
    grunt.registerTask('default', 'Preprocessing and compiling...', ['jshint', 'clean', 'ts', 'copy', 'file_append', 'mochaTest', 'watch']);
